...
void Ins_Btree(PersonalComputer val, btree** q); // добавление вершины в бинарное дерево поиска
...
int Delete(PersonalComputer key, btree** node); // Удаление вершины с заданным значением key
int Get_CountLeaves(btree* p, int count);
